...
// where tab
	...
	protected function isProjectDB()
	{
		...
		if("petugas" == $this->chrt_array['tables'][0])
			return true;
		if("produk" == $this->chrt_array['tables'][0])
			return true;
		if("detailpenjualan" == $this->chrt_array['tables'][0])
			return true;
		if("penjualan" == $this->chrt_array['tables'][0])
			return true;
		if("pelanggan" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
