...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "petugas" ] = array( "url" => "petugas", "type" => 0 );
	$projectEntitiesReverse[ "petugas" ] = "petugas";
	$projectEntities[ "produk" ] = array( "url" => "produk", "type" => 0 );
	$projectEntitiesReverse[ "produk" ] = "produk";
	$projectEntities[ "detailpenjualan" ] = array( "url" => "detailpenjualan", "type" => 0 );
	$projectEntitiesReverse[ "detailpenjualan" ] = "detailpenjualan";
	$projectEntities[ "penjualan" ] = array( "url" => "penjualan", "type" => 0 );
	$projectEntitiesReverse[ "penjualan" ] = "penjualan";
	$projectEntities[ "pelanggan" ] = array( "url" => "pelanggan", "type" => 0 );
	$projectEntitiesReverse[ "pelanggan" ] = "pelanggan";
}
