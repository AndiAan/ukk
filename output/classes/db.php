...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "kasir_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "detailpenjualan", "varname" => "kasir_at_localhost__detailpenjualan", "altvarname" => "detailpenjualan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
			$dalTables[$conn->connId][] = array("name" => "pelanggan", "varname" => "kasir_at_localhost__pelanggan", "altvarname" => "pelanggan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
			$dalTables[$conn->connId][] = array("name" => "penjualan", "varname" => "kasir_at_localhost__penjualan", "altvarname" => "penjualan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
			$dalTables[$conn->connId][] = array("name" => "petugas", "varname" => "kasir_at_localhost__petugas", "altvarname" => "petugas", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
			$dalTables[$conn->connId][] = array("name" => "produk", "varname" => "kasir_at_localhost__produk", "altvarname" => "produk", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
		}
	}
