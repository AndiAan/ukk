...
require_once("include/petugas_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "petugas_print";
...
$page_layouts["petugas_print"] = $layout;
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "petugas" );
