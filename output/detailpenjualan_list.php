...
$layout = new TLayout("list_bootstrap1", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "detailpenjualan_list";
...
$page_layouts["detailpenjualan_list"] = $layout;
...
$layout = new TLayout("masterlist_bootstrap", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "produk_masterlist";
...
$page_layouts["produk_masterlist"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "penjualan_masterlist";
$layout->blocks["bare"] = array();
$layout->containers["column"] = array();
$layout->container_properties["column"] = array(  );
$layout->containers["column"][] = array("name"=>"masterlistheader",
...
$layout->blocks["bare"][] = "mastergrid";
$page_layouts["penjualan_masterlist"] = $layout;
