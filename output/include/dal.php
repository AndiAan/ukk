...
function UsersTableName()
{
	...
	return $connection->addTableWrappers("petugas");
}
...
class tDAL
{
	var $tblkasir_at_localhost__detailpenjualan;
	var $tblkasir_at_localhost__pelanggan;
	var $tblkasir_at_localhost__penjualan;
	var $tblkasir_at_localhost__petugas;
	var $tblkasir_at_localhost__produk;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "detailpenjualan", "varname" => "kasir_at_localhost__detailpenjualan", "altvarname" => "detailpenjualan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
		$this->lstTables[] = array("name" => "pelanggan", "varname" => "kasir_at_localhost__pelanggan", "altvarname" => "pelanggan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
		$this->lstTables[] = array("name" => "penjualan", "varname" => "kasir_at_localhost__penjualan", "altvarname" => "penjualan", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
		$this->lstTables[] = array("name" => "petugas", "varname" => "kasir_at_localhost__petugas", "altvarname" => "petugas", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
		$this->lstTables[] = array("name" => "produk", "varname" => "kasir_at_localhost__produk", "altvarname" => "produk", "connId" => "kasir_at_localhost", "schema" => "", "connName" => "kasir at localhost");
	}
