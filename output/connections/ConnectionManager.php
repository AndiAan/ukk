...
class ConnectionManager
{
	...
	{
		return $this->byId( "kasir_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "kasir_at_localhost";
		$data["connName"] = "kasir at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;kasir;;1"; //currently unused

		$this->_connectionsIdByName["kasir at localhost"] = "kasir_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "kasir";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=kasir;OPTION=3";
		// encription set
		...
		$connectionsData["kasir_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["petugas"] = "kasir_at_localhost";
		$connectionsIds["produk"] = "kasir_at_localhost";
		$connectionsIds["detailpenjualan"] = "kasir_at_localhost";
		$connectionsIds["penjualan"] = "kasir_at_localhost";
		$connectionsIds["pelanggan"] = "kasir_at_localhost";
