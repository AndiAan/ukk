...
require_once("include/pelanggan_variables.php");
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "pelanggan_edit";
...
$page_layouts["pelanggan_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "pelanggan_list";
...
$page_layouts["pelanggan_list"] = $layout;
...
$keys = array();
$keys["PelangganID"] = postvalue("editid1");
