...
$layout = new TLayout("edit_bootstrap", "DeliciousOffice", "MobileOffice");
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "penjualan_edit";
...
$page_layouts["penjualan_edit"] = $layout;
...
$layout->version = 3;
	$layout->bootstrapTheme = "cerulean";
		$layout->customCssPageName = "penjualan_list";
...
$page_layouts["penjualan_list"] = $layout;
...
$keys = array();
$keys["PenjualanID"] = postvalue("editid1");
